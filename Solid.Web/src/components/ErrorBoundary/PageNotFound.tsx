    ...
    return (
        <div className="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900">
            ...
            <div className="text-center xl:max-w-4xl">
                ...
                <Link to="/" className="text-white inline-flex items-center text-white bg-primary border-perso focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
